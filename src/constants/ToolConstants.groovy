...
class ToolConstants {
    ...
    static final String NGBUILD = ROOT + 'npm\\ng.cmd'
    static final String NPM = '"c:\\program files\\nodejs\\npm.cmd"'
    static final String NUGET = ROOT + 'nuget\\nuget.exe'
    static final String NUNIT = ROOT + 'nunit\\nunit3-console.exe'
    static final String SQLPACKAGE = '"c:\\program files (x86)\\microsoft sql server\\130\\dac\\bin\\sqlpackage.exe"'
}
